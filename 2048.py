...
bottom.pack()
#====================================================
b00=Button(top,font=('arial',20,'bold'),text='',bd=10,padx=18,pady=10,height = 1, width = 2)
b00.grid(row=1,column=0)

b01=Button(top,font=('arial',20,'bold'),text='',bd=10,padx=18,pady=10,height = 1, width = 2)
b01.grid(row=1,column=1)

b02=Button(top,font=('arial',20,'bold'),text='',bd=10,padx=18,pady=10,height = 1, width = 2)
b02.grid(row=1,column=2)

b03=Button(top,font=('arial',20,'bold'),text='',bd=10,padx=15,pady=10,height = 1, width = 2)
b03.grid(row=1,column=3)

b10=Button(top,font=('arial',20,'bold'),text='',bd=10,padx=18,pady=10,height = 1, width = 2)
